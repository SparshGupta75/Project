    ...
    <body>
        ...
        <div class="container w-50">
            ...
            <div class="alert alert-primary d-flex align-items-center" role="alert">
                ...
                <div>
                    &nbsp;Do not share your password with anyone and remember it thoroughly.
                </div>
            </div>
        ...
        <section id="form">
            <div class="content">
                ...
                <ul class="nav nav-pills" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="pill" href="#login">Reset your Password</a>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                    <div id="login" class="container tab-pane active">
                        <form action="ChangePass" method="post" id="reg-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control mt-4" id="exampleFormControlInput2"
                                       placeholder="Enter your new password" name="pass" required>
                            </div>
                            <div class="form-group">
                                <!--<label for="exampleFormControlInput2">Email address</label>--> 
                                <input type="password" class="form-control mt-4" id="exampleFormControlInput2"
                                       placeholder="Re-enter your new password" name="repass" required>
                            </div>
