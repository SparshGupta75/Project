        ...
        <section id="form">
            <div class="content">
                ...
                <ul class="nav nav-pills" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="pill" href="#login">Fill the OTP</a>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                    <div id="login" class="container tab-pane active">
                        <form action="verifyCode" method="post" id="reg-form">


                            <h5>An OTP has been sent to the email you entered before. Fill that to proceed to next steps.</h5>
                            <div class="form-group">
                                <!--<label for="exampleFormControlInput2">Email address</label>--> 
                                <input type="text" class="form-control mt-4" id="exampleFormControlInput2"
                                       placeholder="Fill the OTP" name="authcode" required>
                            </div>
