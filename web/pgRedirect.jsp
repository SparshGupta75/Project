...
parameters.put("MOBILE_NO","5555566666");
parameters.put("EMAIL","test555666@paytm.com");
parameters.put("CALLBACK_URL", "http://localhost:8080/Intern/pgResponse.jsp");  //if payment is canceled then return this page
